  ...
  return (
    <>
      <div className='Add-Button-Container'>
        {floorMutation.error && <div className="error-message" style={{ color: 'red' }}>Space Already Exists!!</div>}
              ...
              <div className="card">
                <div className="image-upload">
                  {image ? (
                    ...
                    <label className="upload-area" onDragOver={(e) => { e.preventDefault(); e.stopPropagation(); }} onDrop={handleDrop}>
                      <input
                        id="add-photo-input"
                        type="file"
                        accept=".jpeg, .jpg, .png"
                ...
                <div className="info">
                  ...
                  <input ref={spaceNumberRef} id="space-number" name="spaceNumber" type="number" required />
                  <label htmlFor="rent">Rent:</label>
                  <input ref={rentRef} id="rent" name="rent" type="number" min="10000" max="900000" defaultValue={30000} required />
                  <div className="vacancy-status">
                    <p>Vacancy:</p>
                    <div className="vacancy-mother-container">
                      <div className="vacancy-input-container">
                        <input ref={vacancyYesRef} id="vacancy-yes" type="radio" name="Vacancy" required /> <label htmlFor="vacancy-yes">Yes</label>
                      </div>
                    </div>
                    <div className="vacancy-mother-container">
                      <div className="vacancy-input-container">
                        <input ref={vacancyNoRef} id="vacancy-no" type="radio" name="Vacancy" defaultChecked required /> <label htmlFor="vacancy-no">No</label>
                      </div>
                    </div>
                  </div>
                  <div className="button-container">
                    ...
                    <button id="cancel-button" onClick={closeModal} onKeyDown={handleEscapeKey} type="button">Cancel</button>
                  </div>
                </div>
              </div>
            </form>
